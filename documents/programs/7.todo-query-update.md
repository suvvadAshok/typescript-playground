1. Learn [fakerjs](https://fakerjs.dev/guide/). Use this library to implement the below functions `getUsers` and `getTodos` in a way that the data is generated randomly.
